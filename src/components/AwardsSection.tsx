...
const AwardsSection = ({ className }: { className?: string }) => {
  ...
  return (
    <section className={twMerge(`my-12 bg-slate-950 py-12 px-8 text-white max-w-xl mx-auto xl:max-w-full`, className)} id="awards">
...
/*
   ...
   <div className=''>
     ...
     <div className="mb-16">
       <h3 className="text-4xl md:text-6xl font-bold"></h3>
     </div>
